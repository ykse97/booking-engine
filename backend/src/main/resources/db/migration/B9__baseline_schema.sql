...
-- Baseline schema for new environments after V1-V9.
-- Security-sensitive bootstrap provisioning is intentionally excluded from the
-- baseline so admin accounts are created only through the controlled bootstrap
-- flow.
